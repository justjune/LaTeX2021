...
\begin{titlepage}
	...
	\vspace{1cm}
	\textbf{ДВИЖЕНИЕ ТВЕРДОГО ТЕЛА\\ ВОКРУГ НЕПОДВИЖНОЙ ТОЧКИ}\\
	Направление подготовки 01.03.03 <<Механика и математическое моделирование>>
	\vspace{1cm}

	\begin{tabular}{lcc}
		Директор департамента: & \hspace{2cm} & Выпускная калификационная\\
		к. ф.-м. н., доц. Е.\,С.\,Пьянзина & \hspace{2cm} & работа бакалавра \\
		% Создать просто таблицу внутри для ФИО
		& \hspace{2cm} & \begin{tabular}{c}\textbf{Баранова}\end{tabular}\\
		& \hspace{2cm} & \begin{tabular}{c}\textbf{Ивана Александровича}\end{tabular}\\
		& \hspace{2cm} & \\
		\makebox[6cm]{\hrulefill} & \hspace{2cm} & \makebox[6cm]{\hrulefill}\\
		Нормоконтролер: & \hspace{2cm} & Научный руководитель:\\
		О.\,А.\,Суслова & \hspace{2cm} & к. ф.-м. н., доц. С. И. Осипов\\
		& \hspace{2cm} & \\
		\makebox[6cm]{\hrulefill} & \hspace{2cm} & \makebox[6cm]{\hrulefill}
	\end{tabular}
	\vfill
...
Обосновывающее тему; актуальность решаемой научной задачи и место представляемой работы в ее решении; свзяль с предыдущими исследованиями.
